...
autocmd FileType sh,bash setlocal smarttab expandtab shiftwidth=2 colorcolumn=
autocmd FileType javascript setlocal smarttab expandtab shiftwidth=2 colorcolumn=
